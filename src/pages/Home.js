      ...
      <div className={styles.PresentWrapper}>
        ...
        <div className={styles.PresentTextWrapper}>
          ...
          <p>
             ...
             </p > <p style={{color:'white', fontWeight:'bold'}}className={styles.tabp}>1pm - 9pm <br/> December 18th, 2021.</p><p className={styles.deskp}> 1725 Naud st, Los Angeles, CA 90012 | Chinatown DTLA</p>
